<link rel="stylesheet" href="<?php echo BASEURL.'/public/assets/css/article.css'?>"/>
<?php include "components/header.php"; ?>
    
    <div class="nav">
      <a  href="<?php echo BASEURL.'/articles'?>" >Articles</a>
      <a href="<?php echo BASEURL.'/testTypes'?>" class="activ">Test Types</a> 
    </div> 
    ...
    <div class="main">
        ...
        <div class="box">
          ...
          <button class="btn" onclick="window.location.href='<?php echo BASEURL.'/testTypes'?>'">Back<i class="fas fa-angle-double-left"></i></button>
