...
<?php include "components/sidenav.php"; ?>
    ...
    <div class="nav">
      <a href="<?php echo BASEURL.'/home/articles'?>">Articles</a>
      <a class="activ" href="<?php echo BASEURL.'/home/testTypes'?>">Test types</a>
    </div> 
    ...
    <div class="main">
      ...
      <div class="box">
        ...
        <button class="btn" onclick="window.location.href='<?php echo BASEURL.'/testDetails'?>'">Read more</button>
      </div>
