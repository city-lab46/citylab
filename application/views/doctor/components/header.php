  ...
  <div class="container">
    <div id="mySidenav" class="sidenav">
      <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
        ...
        <button class="button" onclick="window.location.href='<?php echo BASEURL.'/login/logout'?>'">Logout</button>
    ...
    <div class="sidebar">                               
      ...
      <div id="nav">
        ...
        <a class="link" href="<?php echo BASEURL.'/patient/search'?>"><i class="far fa-user"></i><span>Patient</span></a>
        <a class="link" href="<?php echo BASEURL.'/article/search'?>"><i class="far fa-file-alt"></i><span>Articles</span></a>
        <a class="link" href="<?php echo BASEURL.'/settings/doctor'?>"><i class="fas fa-cog"></i><span>Settings</span></a>
      </div>
...
$(function(){
    ...
    <div class="dropdown">
      ...
      <div class="user_image">
        <a href="<?php echo BASEURL.'/settings/doctor'?>">
          <img src="<?php echo BASEURL.'/public/assets/img/doc.jpg'?>" alt=""></img>
        </a>
      </div>
      <div class="user_name">Mr. Samaranayake</div>
      <div id="user-role">Doctor</div>
