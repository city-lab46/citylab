        ...
        <div class="main">
            ...
            <div class="contents">
                <div style="margin:20px 0px;text-align:right;">
                    <a href="<?php echo BASEURL.'/salary/doctor'?>" class="button_link">Back to List</a>
                </div>

                <div class="frm-add">
                    <h1 class="demo-form-heading">Edit Record</h1>
                    <form name="frmAdd" action="<?php echo BASEURL.'/salary/update'?>" method="POST">
                        <input type="hidden" name="docId" value="<?php echo $result[0]['doctor_id'];?>" required />
                        ...
                        <div class="demo-form-row">
                            ...
                            <input type="text" name="new_salary" class="demo-form-field" value="<?php echo $result[0]['new_salary']; ?>" required />
                        </div>
                        <div class="demo-form-row">
